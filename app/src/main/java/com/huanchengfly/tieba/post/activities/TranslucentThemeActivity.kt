...
class TranslucentThemeActivity : BaseActivity<ActivityTranslucentThemeBinding>(), View.OnClickListener, OnSeekBarChangeListener,
    ...
    private val mTranslucentThemeColorAdapter: TranslucentThemeColorAdapter by lazy {
        TranslucentThemeColorAdapter(this)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setViewBinding(ActivityTranslucentThemeBinding.inflate(layoutInflater))
        ...
        binding?.wallpapersRv?.addItemDecoration(
            HorizontalSpacesDecoration(0, 0, 16.dpToPx(), 16.dpToPx(), false)
        )
    ...
    private fun invalidateFinishBtn() {
        binding?.buttonFinish?.visibility = if (mUri != null) View.VISIBLE else View.GONE
    }
